...
<div><input type="text" class="search-box-1 search-img" value=""         placeholder="Search Term" /></div>
    </div>
                ...
                <div class="table-csv-list">
                    ...
                    <div class="location-table-row1 clearfix">
                        ...
                        <div class="table-blank-h1-e">
                            <a href="javascript:;" onclick="editLocation('<?= $location['_id'] ?>', this)" class="edit1-btn"></a> 
